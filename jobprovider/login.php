<?php
  ...
  if(isset($_POST['submit']))
  {
    ...
    $query = "SELECT * FROM jplogin WHERE email = '$email' AND pass = '$pass' AND status='1'" ;
...
<!--  nav bar starts here -->
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark blue-gradient scrolling-navbar">
        <a class="navbar-brand" href="../">iGen Systems LLC - Jobs</a>
          ...
          <div class="col-6">
            ...
            <div class="card">
              ...
              <form class="text-center border border-light p-5" action="login.php" method="POST">
                  ...
                  <!-- Sign in button -->
                  <button class="btn btn-info btn-block blue-gradient" name="submit" type="submit">Sign in</button><br>
...
<div class="container-fluid text-center text-md-left">
  ...
  <div class="row">
    ...
    <div class="col-md-3 mb-md-0 mb-3">
      ...
      <hr class="teal accent-3 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
      <p>
        <i class="fas fa-home mr-3"></i> 196 Princeton Hightstown Rd, West Windsor Township,NJ 08550, United States</p>
      <p>
        <i class="fas fa-envelope mr-3"></i> support@igen-systems.com</p>
      <p>
        <i class="fas fa-phone mr-3"></i> +1 908-941-0361</p>
      <p>
        <i class="fas fa-print mr-3"></i> +1 908-941-0361</p>
      </div>
      <!-- Grid column -->
