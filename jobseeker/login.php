<?php
  ...
  if(isset($_POST['submit']))
  {
    ...
    $query = "SELECT * FROM jslogin WHERE email = '$email' AND pass = '$pass' AND status='1'" ;
    ...
    <div class="container-fluid text-center text-md-left">
      ...
      <div class="row">
        ...
        <div class="col-md-6 mt-md-0 mt-3">
          ...
          <!-- Content -->
          <h5 class="text-uppercase">iGen Systems LLC - Jobs</h5><br><br>
        ...
        <div class="col-md-3 mb-md-0 mb-3">
          ...
          <hr class="teal accent-3 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
          <p>
            <i class="fas fa-home mr-3"></i>196 Princeton Hightstown Rd, West Windsor Township,<br>
					NJ 08550, United States</p>
          <p>
