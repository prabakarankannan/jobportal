...
// extract all values from form in the this below variables
  ...
  $query="SELECT * FROM `jsdetails` WHERE email='$email';";
      ...
      <div class="row">
          ...
          <div class="card" style="width: 60rem;">
            ...
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item">Mobile : <?php echo $data['mob']; ?></li>
              <li class="list-group-item">State : <?php echo $data['state']; ?></li>
              <li class="list-group-item">City : <?php echo $data['city']; ?></li>
              <li class="list-group-item">City : <?php echo $data['address']; ?></li>
              <li class="list-group-item">Resume : <a href="<?php echo $data['resumeurl']; ?>">View</a></li>
            ...
            <div class="card-body">
              <a href="editprofile.php">
                <button type="button" class="btn btn-primary btn-rounded  blue-gradient">Edit Profile</button>
              </a>
            </div>
          -->
          </div>
